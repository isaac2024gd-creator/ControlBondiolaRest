                        ...
                        {emps.map((emp) => {
                          ...
                          return (
                            <button
                              ...
                              style={{
                                background: sel ? paper : dentro ? sage + "2E" : "transparent",
                                border: `1px solid ${sel ? (dentro ? sage : paper) : dentro ? sage + "99" : steel + "55"}`,
                              }}
                            >
                              <span className="text-xs font-bold" style={{ color: sel ? ink : paper }}>
                                {emp.name}
                              </span>
                              <span className="text-[10px] font-bold" style={{ color: sel ? ink + "99" : dentro ? sage : steel }}>
