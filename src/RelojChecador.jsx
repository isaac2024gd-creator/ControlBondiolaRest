    ...
    >
      ...
      {tab === "checador" && (
        <div className="flex-1 px-5 py-5 flex flex-col gap-5">
          <div
            className="rounded-sm p-4 flex flex-col items-center justify-center"
              ...
              return (
                <>
                  <div
                    ...
                    style={{ color: paper, fontSize: "2.75rem", letterSpacing: "0.02em", lineHeight: 1 }}
                  >
                    {horaTexto}
                  </div>
                  <div
                    className="text-xs font-bold uppercase mt-1"
                    style={{ color: brass, letterSpacing: "0.08em" }}
                  >
                    {fechaCap}
                  </div>
                </>
